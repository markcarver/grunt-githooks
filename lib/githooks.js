...
Hook.prototype = {
  ...
  getGruntPath: function () {

    // Quick and dirty into the arguments of the command that ran grunt
    // [0] would be 'node'
    // [1] the path to grunt (Yeah!!!)
    // [2] and higher the arguments passed to Grunt
